...
{
    public interface IFindByWindowsUIAutomation<out W> : IFindsByFluentSelector<W> where W : IWebElement
    {
        /// <summary>
        ...
        IReadOnlyCollection<W> FindElementsByWindowsUIAutomation(string selector);
    }
}