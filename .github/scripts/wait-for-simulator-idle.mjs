// Adapted from appium/appium-xcuitest-driver scripts/ci/wait-for-simulator-idle.mjs.
// Keep the idle thresholds and best-effort timeout aligned with upstream.
