...
- Updated mechanism of embedding application resources. Fixes (#356) InvalidCastException error when locating node path on non-windows host & net45 target (#357)
