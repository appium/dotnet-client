...
- Removed the need to embed application resource for finding node instane path. Fixes (#356) InvalidCastException error when locating node path on non-windows host & net45 target (#357)
